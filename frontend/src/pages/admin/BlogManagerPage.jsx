...
import {
  PenSquare, Trash2, Plus, FileText, Globe, Eye, EyeOff,
...
export default function BlogManagerPage() {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      {!blogEnabled && (
        <div className="mb-5 flex items-center gap-3 p-4 bg-amber-50 border border-amber-200 rounded-xl text-sm text-amber-700">
          <AlertCircle size={16} className="flex-shrink-0 text-amber-500" />
          Blog is disabled — posts won't appear on your public site until you enable it.
        </div>
      )}
            ...
            >
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3 mt-1">
                  ...
                  <span className="text-xs text-gray-300">/{post.seo?.slug}</span>
                </div>
              </div>
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium text-red-500 bg-red-50 hover:bg-red-100 transition-colors disabled:opacity-50"
                >
